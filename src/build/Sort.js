...
export const Sort = () => {
  ...
  const uniqueEyeColors = users.reduce((acc, { eyeColor }) => {
  ...
  firstNameSelect.addEventListener('change', (e) => {
  ...
  lastNameSelect.addEventListener('change', (e) => {
    const target = e.target;
    if (target.value == 'default') {
  ...
  eyeColorSelect.addEventListener('change', (e) => {
    ...
    if (target.value == 'default') {
      ...
      lastNameSelect.selectedIndex = 0;
      aboutSelect.selectedIndex = 0;
      sortBy.renderArray = sortBy.renderArray.reduce((acc, obj) => {
